...
def get_formatter(input_list):
    ...
    elif (prob >= 0.925) & (input_range <= 1e5):  # use other formatters
...
def get_interpolated_data(x, y):
    ...
    if random.random() >= 0.5:
        ...
        fractions = np.linspace(0, 1, random.randint(3, 6))
